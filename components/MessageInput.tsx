...
import { Download, ArrowBigUp } from "lucide-react";
      ...
      <div className="relative max-w-4xl mx-auto flex items-end gap-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className="h-10 w-10 rounded-xl bg-gray-700 hover:bg-gray-500 text-white transition-all duration-150 ease-in-out flex items-center justify-center cursor-pointer shadow-md focus:outline-none focus:ring-3 focus:ring-blue-300/50 disabled:opacity-35 disabled:cursor-not-allowed flex-shrink-0"
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full min-h-[44px] max-h-[200px] bg-gray-800/80 backdrop-blur-sm text-white rounded-xl pl-4 pr-4 py-2.5 text-sm leading-snug focus:outline-none focus:ring-2 focus:ring-blue-500/50 border-[0.5px] border-gray-700/50 hover:border-blue-500/30 transition-all resize-none shadow-md overflow-y-auto placeholder:text-gray-500"
            rows={1}
        ...
        <Button
          type="submit"
          size="icon"
          className="h-10 w-10 rounded-xl bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 ease-in-out flex items-center justify-center cursor-pointer shadow-md focus:outline-none focus:ring-3 focus:ring-blue-460/50 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
