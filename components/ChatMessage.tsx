...
export function ChatMessage({ message }: ChatMessageProps) {
  ...
  return (
    <div className={`
      p-4 rounded-xl mb-4 backdrop-blur-sm border border-opacity-20 w-full mx-auto
      transition-all duration-200 hover:border-opacity-70
      ${
        isUser
          ? 'bg-blue-600/10 border-blue-500 text-right'
          : 'bg-gray-800/40 border-gray-700 text-left shadow-[0_5px_15px_rgba(0,0,0,0.1)]'
      }
    `}>
